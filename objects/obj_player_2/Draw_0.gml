...
drawAimLineEffect = function() {
	var aimlength_x = x + lengthdir_x(350, image_angle);
	var aimlength_y = y + lengthdir_y(350, image_angle);
	...
	if (gamepad_button_check_pressed(0, gp_shoulderrb)) { toggleAimLine = !toggleAimLine }
...
drawExperienceBar(); // Dibujar Barra
